        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            ...
            <Input
              ...
              onChange={(e: any) => handlePriceChange("NGN", e.target.value)}
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <Input
              ...
              onChange={(e: any) => handlePriceChange("USD", e.target.value)}
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <Input
              ...
              onChange={(e: any) => handlePriceChange("GBP", e.target.value)}
            />
          </div>
        </div>
